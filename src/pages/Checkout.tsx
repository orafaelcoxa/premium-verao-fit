...
const Checkout = () => {
  ...
  const benefits = [
    ...
    "Estratégias de alimentação ajustadas",
    "Acompanhamento semanal direto",
    "Ajustes mensais conforme evolução",
    "Suporte via WhatsApp",
    "Acesso ao app de treinos personalizado"
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="p-8 bg-card/90 backdrop-blur border-2 border-primary/20 animate-slide-in">
              ...
              <div className="mt-8 pt-8 border-t border-border">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-4xl font-black text-gradient">R$ 297</span>
                </div>
            ...
            <Card className="p-8 bg-card/90 backdrop-blur border-2 border-primary/20 animate-slide-in">
              ...
              {paymentMethod === "pix" && (
                <div className="mb-8 p-6 bg-primary/10 rounded-lg border border-primary animate-fade-in">
              ...
              <Button
                size="lg"
                className="w-full text-xl py-8 bg-primary hover:bg-primary/90 shadow-red transition-all duration-300 hover:scale-105 glow-red font-bold"
                onClick={() => {
